...
java -Xbootclasspath/p:slf4j-api-1.7.30.jar:logback-classic-1.2.3.jar:logback-core-1.2.3.jar:sqlite-jdbc-3.30.1.jar -jar liquibase.jar --logLevel=debug --driver=org.sqlite.JDBC --url="jdbc:sqlite:../tinyurlgorm.db" --changeLogFile=./liquibase-changelog.xml update
